...
import type { SplitWithMeta } from './balances'
...
export async function fetchSplitForTransaction(transactionId: string) {
...
/** Record a settlement payment as an expense attributed to the payer, then mark shares settled. */
