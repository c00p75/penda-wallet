import { addLocalDays, localDateStr, parseLocalDate } from './dates'

export type RecurringFrequency = 'daily' | 'weekly' | 'monthly' | 'yearly'

/**
 * The minimal recurring-rule shape this projection needs. Kept structural (not
 * tied to either app's full RecurringTransaction) so both web and mobile can
 * pass their richer types in without this package importing app code.
 */
