import type { RecurringFrequency, RecurringTransaction } from '@/src/api/types';
import { addLocalDays, localDateStr, parseLocalDate } from '@/src/lib/dates';
...
export interface CashflowProjection {
  ...
  /** Lowest projected balance before the next income lands. Null when no income is expected. */
