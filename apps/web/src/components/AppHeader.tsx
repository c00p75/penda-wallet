...
import { MoneyAccountSwitcher } from '@/features/wallets/MoneyAccountSwitcher'
...
/**
 * Primary-tab chrome: money-account switcher, menu, notifications, profile.
 */
      ...
      <header className="flex items-center justify-between gap-2 px-4 pt-[max(1rem,env(safe-area-inset-top))] pb-3">
        <div className="flex min-w-0 items-center gap-2">
          ...
          <button
            ...
            className="relative grid size-11 shrink-0 place-items-center rounded-2xl bg-card text-foreground shadow-[var(--shadow-soft)] ring-1 ring-border/60 transition-transform active:scale-95"
          >
